    ...
    dcc.Graph(
        ...
        figure={
            ...
            'data': [
                ...
                {'x': weekday_in_order, 'y': ped_s, 'type': 'bar', 'name': 'Ped N'},
                {'x': weekday_in_order, 'y': ped_n, 'type': 'bar', 'name': 'Ped S'},
                {'x': weekday_in_order, 'y': bike_s, 'type': 'bar', 'name': 'Bike N'},
                {'x': weekday_in_order, 'y': bike_n, 'type': 'bar', 'name': 'Bike S'},
